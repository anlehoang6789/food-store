...
import { useListEmployeesQuery } from "@/queries/useAccount";
...
export default function AccountTable() {
  ...
  const listEmployeesMutation = useListEmployeesQuery();
  const data = listEmployeesMutation.data?.payload.data ?? [];
